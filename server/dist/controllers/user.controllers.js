...
exports.deleteSingleUser = exports.putSingleUser = exports.addSingleUser = exports.getAllUsers = void 0;
...
var addSingleUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, user, userSaved, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                data = req.body;
            ...
            case 2:
                userSaved = _a.sent();
                if (userSaved) {
                    res.status(201).json({ message: 'User has been saved', userSaved: userSaved });
                }
                else {
...
var putSingleUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, updatedData, updatedUser, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, user_model_1.default.findByIdAndUpdate(userId, updatedData, {
                        new: true,
                    })];
            case 2:
                updatedUser = _a.sent();
...
exports.putSingleUser = putSingleUser;
